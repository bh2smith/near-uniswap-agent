    ...
    paths: {
        ...
        "/api/tools/uniswap": {
            post: {
                tags: ["uniswap"],
                operationId: "swap",
                summary: "Quote a price and fee for the specified order parameters. Posts unsigned order to Uniswap and returns Signable payload",
                ...
                parameters: [
                    ...
                    },
                    {
                        ...
                        description: "The amount of tokens to sell before fees, represented as a decimal string in token units. Not Atoms.",
                    },
                ],
                // requestBody: {
    ...
    components: {
        ...
        responses: {
            ...
            SignRequestResponse200: {
                description: "Uniswap Fusion order response including transaction and order URL",
                content: {
                    "application/json": {
                        schema: {
                            type: "object",
